...
public class Respuesta implements Cloneable {
    ...
    public int getNivelNoAplica() {
        return nivelNoAplica;
    }

    public void setNivelNoAplica(int nivelNoAplica) {
        this.nivelNoAplica = nivelNoAplica;
    }
