package com.leancleaning.calidad.procedimientos;
...
public class ProcedimientosFragment extends Fragment {
    ...
    public static String TAG = "procedimientos_fragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        fragmentView = inflater.inflate(R.layout.procedimientos, container, false);
        ...
        cargar_preguntas_procedimientos();
    ...
    private void cargar_preguntas_procedimientos(){

        String sede = LeancleaningUtils.getPreferencias("id_sede_seleccionada", "", requireContext());
        String tipo_pregunta = "3"; //Tipo de procedimientos
